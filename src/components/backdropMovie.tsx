...
console.log(movieVideo)
  ...
  return (
    ...
    />
      ...
      sizes="100vw"
    />
    <div className={` h-[375px] text-black xl:text-white xl:h-[264px] w-full xl:w-[404px] absolute xl:top-[182px] xl:left-[140px] text-white flex-col justify-start items-start gap-4 inline-flex ml-8 xl:ml-[0px]`}>
      <h1 className={`w-fit  ${isDark ? 'text-white' : 'text-black'} xl:text-white font-normal leading-normal`}>
        Now Playing:
      </h1>
      <div className={ ` xl:flex-col  justify-start items-start flex`}>
        ...
        <p className={`flex  ${isDark ? 'text-white' : 'text-black'} xl:text-white text-lg font-semibold leading-7`}>
      ...
      <p className={` w-[435px] xl:w-[302px] ${isDark ? 'text-white' : 'text-black'} xl:text-white h-[100px] xl:h-[80px] text-[16px] xl:text-[12px] font-normal leading-none`}>
        {movie.overview}
      </p>

      <Dialog>
              <DialogTrigger>
                <div className="text-secondary-foreground bg-background px-2 py-1 rounded-md flex gap-2">
                  <PlayIcon></PlayIcon>
                  Watch trailer
                </div>
              </DialogTrigger>
